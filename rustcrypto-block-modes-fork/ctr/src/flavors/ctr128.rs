...
#[derive(Clone)]
pub struct CtrNonce128<N: ArrayLength> {
    ctr: u128,
    nonce: GenericArray<u128, N>,
}

#[cfg(feature = "zeroize")]
impl<N: ArrayLength> Drop for CtrNonce128<N> {
    fn drop(&mut self) {
        self.ctr.zeroize();
        self.nonce.zeroize();
    }
...
#[cfg(feature = "zeroize")]
impl<N: ArrayLength> ZeroizeOnDrop for CtrNonce128<N> {}
...
where
    B: ArrayLength + PartialDiv<ChunkSize>,
    Chunks<B>: ArrayLength,
{
