    ...
    NonceSize<A, Self>: ArrayLength,
{
    ...
    type NonceOverhead: ArrayLength;
...
where
    A: AeadInPlace,
    A::NonceSize: Sub<U5>,
    <<A as AeadCore>::NonceSize as Sub<U5>>::Output: ArrayLength,
{
...
where
    A: AeadInPlace,
    A::NonceSize: Sub<U4>,
    <<A as AeadCore>::NonceSize as Sub<U4>>::Output: ArrayLength,
{
    /// Underlying AEAD cipher
    aead: A,
