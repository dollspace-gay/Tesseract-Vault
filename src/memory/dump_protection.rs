...
//!
//! ```no_run
//! use secure_cryptor::memory::dump_protection::{disable_core_dumps, disable_crash_dumps};
//!
...
///
/// ```no_run
/// use secure_cryptor::memory::dump_protection::disable_core_dumps;
///
/// disable_core_dumps().expect("Failed to disable core dumps");
/// ```
...
///
/// ```no_run
/// use secure_cryptor::memory::dump_protection::disable_crash_dumps;
///
/// disable_crash_dumps().expect("Failed to disable crash dumps");
/// ```
...
///
/// ```no_run
/// use secure_cryptor::memory::dump_protection::disable_all_dumps;
///
...
///
/// ```no_run
/// use secure_cryptor::memory::dump_protection::DumpProtectionGuard;
///
/// {
