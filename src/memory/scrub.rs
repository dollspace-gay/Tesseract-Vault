...
//!
//! ```
//! use tesseract_lib::memory::scrub::{scrub_bytes, scrub_bytes_pattern, ScrubPattern};
//!
...
///
/// ```
/// use tesseract_lib::memory::scrub::scrub_bytes;
///
...
///
/// ```
/// use tesseract_lib::memory::scrub::{scrub_bytes_pattern, ScrubPattern};
///
/// let mut secret = vec![0x42; 256];
...
///
/// ```
/// use tesseract_lib::memory::scrub::{scrub_and_verify, ScrubPattern};
///
/// let mut secret = vec![0x42; 256];
...
///
/// ```
/// use tesseract_lib::memory::scrub::ScrubGuard;
///
/// {
...
///
/// ```
/// use tesseract_lib::memory::scrub::scrub_stack_buffer;
///
...
///
/// ```
/// use tesseract_lib::memory::scrub::scrub_multiple;
///
